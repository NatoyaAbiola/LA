...
puts  "Hello #{name}, I heard you are looking for a denim shirt.  I can help you to find it. "
...
while box_1.include? ('denim shirt')
   puts "Yes, we have the item you are looking for"
    number = rand 0..6
  while number != 0
    if number == 0
    break
...
elsif box_1.include? ("silver nail polish")
      puts "Unfortunately, this box does not contain black nail polish.The box contains silver nail polish."
end
...
box_3.include? ('skinny jeans')
    puts "We have a full box of skinny jeans"
    number = rand 0..6
   while number != 0
    if number == 0
     break
 ...
 puts "We have skinny jeans and other items in this box."
