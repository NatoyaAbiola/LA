...
For every element called 'number' in the array 'numbers', multiply number by 3 and print out 'number'
For every element called 'name' in the array 'names', print out 'name'For every element called 'name' in the array 'names', print out the length of each name

For every element called 'number' in the array 'numbers', add the number to the variable sum, then print out the sum of all numbers

For every element in the hash, print out the key (name) and value (age) using a sentence

Sum up the value of each key (transaction) in the hash. Using a string, output the sum of all values in the hash

For every element in the hash, print out the key (name) and value (address) using a sentence (string)
...
numbers.each do |phone_number|
  ...
  if numbers.include? ("MA area code")
