...
let ourShip = new Ship("Panama Supreme");

let crewNames = ["Etienne", "Ramil", "Natoya", "Annetta", "Neola"];
...
let rocket = {
  ...
  addFuel : function(int){
    ...
    return ("Adding fuel....new fuel amount is: " + rocket.fuel);},
  fire : function(){
    if (rocket.fuel === 0) {
...
let shipNames = ["Demerara", "Rah", "Marley", "Panama Supreme"];
function Fleet(name){
  this.name = name;
  this.ships = [];
...
// console.log(rocket.fire());
let kresoFleet = new Fleet("My fleet")
